...
Then(
  "el administrador deberia ver el nuevo miembro en la lista de miembros",
  function () {
...
Then(
  "el administrador modifica el titulo y la descripcion del sitio",
  function () {
...
When(
  "el administrador hace click en el botón de guardar configuracion",
  function () {
